...
class Cnf_settingController extends Controller
{
    public function store()
    {
        ...
        if (Request::ajax()) {
            ...
            if ($validator->fails()) {
                ...
                $setting = Cnf_setting::where('type', '=', 'schedule')->first();
    ...
    public function show()
    {
        ...
        if (Sentinel::check()) {
            ...
            return View('backend.pages.modules.conference.settings', compact('settings', 'userRoles'));
        } else {
