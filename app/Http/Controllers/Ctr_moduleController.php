...
class Ctr_moduleController extends Controller
{
...
//        $total_categories_cnt = Ct_category::select('*')->count();
    ...
    public function catering_stats()
    {
        ...
        $active_ingredients_cnt = Ctr_ingredient::where('state', '=', '1')->count();
    ...
    public function show_dashboard()
    {
        if (Sentinel::check()) {
            ...
            return View('backend.pages.modules.catering.dashboard', compact('userRoles', 'active_categories_cnt', 'active_quantities_cnt', 'active_groups_cnt', 'active_ingredients_cnt'));
        } else {
