jQuery(document).ready(function () {
    ...
    CKEDITOR.replace('speaker_description', {
        customConfig: "../../pages/modules/conference/speakers/ckeditor-config.js"
    });

    $('#contact-list').html('<div class="text-center"><i class="fa fa-spinner fa-4x fa-spin"></i><br/><br/></div>');
    jQuery.ajax({
        url: "/backend/modules/conference/speakers/speaker_list",
        type: "GET",
    ...
    $("#speaker-list").on('click', '.speaker_delete', function (event) {
        ...
        swal({
            ...
            function(){
                $.ajax({
                    url: '/backend/conference/speakers/delete',
                    type: "post",
                    data: {
    ...
    $('#form_speakers').validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '/backend/modules/conference/speakers/store',
                type: "post",
                data: {
