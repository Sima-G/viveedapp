jQuery(document).ready(function () {
    ...
    CKEDITOR.replace('schedule_description', {
        customConfig: "../../pages/modules/conference/settings/ckeditor-config.js"
    });
    ...
    $('#form_settings').validate({
        ...
        submitHandler: function (form) {
            $.ajax({
                url: '/backend/modules/conference/settings/store',
                type: "post",
                data: {
                ...
                success: function getcontent(session_title) {
                    ...
                    jQuery.ajax({
                        url: "/backend/modules/conference/settings/data",
