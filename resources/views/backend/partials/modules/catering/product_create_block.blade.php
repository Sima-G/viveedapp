<div id="product_manage_block" class="block">
    ...
    <div class="block-title">
        <div class="block-options pull-right">
            <h2>(@lang('backend/modules/catering/products.create_new'))</h2>
        </div>
    ...
    <!-- Add Product Content -->
    <form id="form_products_manage" action="/backend/modules/catering/products/store_product" enctype="multipart/form-data" method="post" class="form-horizontal form-bordered product-create-form" onsubmit="return false;">
