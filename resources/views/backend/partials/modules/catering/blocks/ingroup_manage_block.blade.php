<div id="ingroup_manage_block" class="block">
    ...
    <form id="form_ingroups_manage" enctype="multipart/form-data" method="post" class="form-horizontal form-bordered" onsubmit="return false;">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="col-xs-3 control-label" for="ingroup_title">@lang('backend/modules/catering/ingroups.title') <span class="text-danger">*</span></label>
                <div class="col-xs-9">
                    <select id="ingroup_title" name="ingroup_title" class="chosen-select chosen-select-width chosen-select-no-results quantity-control" style="width: 100%;" data-placeholder="@lang('backend/modules/catering/ingroups.title_desc')" style="width: 250px;">
                    </select>
                </div>
            </div>
