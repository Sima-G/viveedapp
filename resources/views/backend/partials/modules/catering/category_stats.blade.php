    ...
    <div class="col-sm-6 col-lg-3">
        <a href="javascript:void(0)" class="widget widget-hover-effect2">
            <div class="widget-extra themed-background-dark">
                <h4 class="widget-content-light"><strong>@lang('backend/modules/catering/categories.total')</strong> @lang('backend/modules/catering/categories.of_subcategories')</h4>
            </div>
            <div class="widget-extra-full"><span class="h2 themed-color-dark animation-expandOpen">{{ $total_subcategories_cnt }}</span></div>
        </a>
    </div>