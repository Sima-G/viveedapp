<div class="content-header">
    <ul class="nav-horizontal text-center">
        <li @if(Route::current()->getName() == 'ct_dashboard') class="active" @endif >
            <a href="{{URL::route('ct_dashboard')}}"><i class="fa fa-bar-chart"></i> @lang('backend/modules/catering/menu.view_dashboard') <br> @lang('backend/modules/catering/menu.of_products')</a>
        </li>
        <li @if(Route::current()->getName() == 'ct_products') class="active" @endif >
            <a href="{{URL::route('ct_products')}}"><i class="gi gi-shop_window"></i> @lang('backend/modules/catering/menu.list') <br> @lang('backend/modules/catering/menu.of_existing_products')</a>
        </li>
