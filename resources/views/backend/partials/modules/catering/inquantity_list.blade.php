@if($inquantities->count())
    ...
    <table class="table table-bordered table-striped table-vcenter">
        ...
        @foreach($inquantities as $key => $inquantity)
            <tr>
...
@else
    <div class="block-section text-center">
        <h2><span id="manage_inquantity_block_action">@lang('backend/modules/catering/inquantities.empty_inquantity_list')</span></h2>
    </div>
@endif