<div id="catalogue_manage_block" class="block">
    ...
    <form id="form_catalogues_manage" action="" enctype="multipart/form-data" method="post" class="form-horizontal form-bordered quantity-manage-form" onsubmit="return false;">
        ...
        <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <select id="catalogue_status" name="catalogue_status" class="form-control" readonly="readonly">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <select id="catalogue_state" name="catalogue_state" class="form-control" readonly="readonly">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <label class="checkbox-inline" for="selected_date_sun">
                                <input id="catalogue_day_sun" name="catalogue_day" value="1" type="checkbox"> @lang('backend/modules/pricing/catalogues.sun')
                            </label>
                            <label class="checkbox-inline" for="selected_date_mon">
                                <input id="catalogue_day_mon" name="catalogue_day" value="2" type="checkbox"> @lang('backend/modules/pricing/catalogues.mon')
                            </label>
                            <label class="checkbox-inline" for="selected_date_tue">
                                <input id="catalogue_day_tue" name="catalogue_day" value="4" type="checkbox"> @lang('backend/modules/pricing/catalogues.tue')
                            </label>
                            <label class="checkbox-inline" for="selected_date_wed">
                                <input id="catalogue_day_wed" name="catalogue_day" value="8" type="checkbox"> @lang('backend/modules/pricing/catalogues.wed')
                            </label>
                            <label class="checkbox-inline" for="selected_date_thu">
                                <input id="catalogue_day_thu" name="catalogue_day" value="16" type="checkbox"> @lang('backend/modules/pricing/catalogues.thu')
                            </label>
                            <label class="checkbox-inline" for="selected_date_fri">
                                <input id="catalogue_day_fri" name="catalogue_day" value="32" type="checkbox"> @lang('backend/modules/pricing/catalogues.fri')
                            </label>
                            <label class="checkbox-inline" for="selected_date_sat">
                                <input id="catalogue_day_sat" name="catalogue_day" value="64" type="checkbox"> @lang('backend/modules/pricing/catalogues.sat')
                            </label>
                                <input type="hidden" name="catalogue_days" id="catalogue_days">
                        </div>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="input-group input-daterange" data-date-format="dd/mm/yyyy">
                        <input type="text" id="catalogue_start_date" name="catalogue_start_date" class="form-control text-center" readonly="readonly" placeholder="@lang('backend/modules/pricing/catalogues.from')">
                        <span class="input-group-addon"><i class="fa fa-angle-right"></i></span>
                        <input type="text" id="catalogue_end_date" name="catalogue_end_date" class="form-control text-center" readonly="readonly" placeholder="@lang('backend/modules/pricing/catalogues.to')">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="col-md-4 control-label" for="catalogue_start_hour">@lang('backend/modules/pricing/catalogues.selection_of_hours') (@lang('backend/modules/pricing/catalogues.from'))</label>
                    <div class="col-md-8">
                        <div class="input-group bootstrap-timepicker">
                            <input type="text" id="catalogue_start_hour" name="catalogue_start_hour" readonly="readonly" class="form-control input-timepicker24">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="col-md-4 control-label" for="catalogue_end_hour">@lang('backend/modules/pricing/catalogues.selection_of_hours') (@lang('backend/modules/pricing/catalogues.to'))</label>
                    <div class="col-md-8">
                        <div class="input-group bootstrap-timepicker">
                            <input type="text" id="catalogue_end_hour" name="catalogue_end_hour" readonly="readonly" class="form-control input-timepicker24">
                            <span class="input-group-btn">
                                        <a href="javascript:void(0)" class="btn btn-primary"><i class="fa fa-clock-o"></i></a>
                                    </span>
                        </div>
        ...
        <div class="form-group form-actions">
            <div id="catalogue_actions" class="col-xs-9 col-xs-offset-3">
                <input type="hidden" name="catalogue_action_id" id="catalogue_action_id">
                <input type="hidden" name="catalogue_manage_btn_txt" id="catalogue_manage_btn_txt" value="<i class='fa fa-arrow-right'></i> @lang('backend/modules/pricing/catalogues.catalogue_new_save')">
                <input type="hidden" name="catalogue_manage_btn_txt_alt" id="catalogue_manage_btn_txt_alt" value="<i class='fa fa-arrow-right'></i> @lang('backend/modules/pricing/catalogues.catalogue_change_save')">
                <input type="hidden" name="catalogue_undo_btn_txt" id="catalogue_undo_btn_txt" value="<i class='fa fa-repeat'></i> @lang('backend/modules/pricing/catalogues.catalogue_action_undo')">
                <button type="submit" id="catalogue_manage_btn" class="btn btn-sm btn-primary catalogue-manage-btn">
                    <i class='fa fa-arrow-right'></i> @lang('backend/modules/pricing/catalogues.catalogue_new_save')
                </button>
            </div>
        </div>
    </form>
