<div class="block full">
    ...
    <div class="block-title">
        <div class="block-options pull-right">
            <a href="javascript:void(0)" class="btn btn-sm btn-alt btn-default" data-toggle="tooltip" title="" data-original-title="New invoice"><i class="fa fa-plus"></i></a>
            <a href="javascript:void(0)" class="btn btn-sm btn-alt btn-default" data-toggle="tooltip" title="" data-original-title="Delete invoice"><i class="fa fa-times"></i></a>
    ...
    <div class="row block-section">
        <!-- Company Info -->
        <div class="col-sm-6">
            <img src="img/placeholders/avatars/avatar5.jpg" alt="photo" class="img-circle">
            <hr>
        ...
        <div class="col-sm-6 text-right">
            <img src="img/placeholders/avatars/avatar6.jpg" alt="photo" class="img-circle">
            <hr>
