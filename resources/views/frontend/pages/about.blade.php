...
@section('content')
    <div class="mdl-grid demo-content">
        <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
            Βρίσκεστε στην ενότητα<i class="material-icons">more_vert</i>&nbsp;@lang("frontend/master.about")&nbsp;&nbsp;<i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">feedback</i>
