<div class="viveed-updates mdl-card mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--12-col-desktop">
    <div class="mdl-card__title mdl-card--expand mdl-color--teal-300">
        <p title="@lang('frontend/home.desc_alt_text_session_title')">
        <h2 class="mdl-card__title-text">{{ $schedule_config->title }}</h2></p>
    </div>
    ...
    <div class="mdl-card__actions mdl-card--border mdl-grid">
        ...
        <div class="mdl-cell mdl-cell--4-col">
            <!-- Raised button -->
            <button id="previous_date_btn" class="mdl-button mdl-js-button mdl-button--raised date_change_btn"
                    value="-1">
        ...
        <div class="mdl-cell mdl-cell--4-col no-padding">
            ...
            <button id="now_date_btn"
                    class="full-width mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect date_change_btn"
                    value="0">
                @lang('frontend/partials.date_now')
            </button>
        </div>
        <div class="mdl-cell mdl-cell--4-col">
            <!-- Raised button -->
